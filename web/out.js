...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    TextPositioningElement: {
      ...
      rotate$0: function($receiver) {
        return $receiver.rotate.call$0();
      },
    ...
    Input_onMouseMove: [function($event) {
      ...
      $.Input_mouseX = t2.get$x(t2);
      t1 = t1.get$client($event);
      $.Input_mouseY = t1.get$y(t1);
    }, "call$1", "ld38_Input_onMouseMove$closure", 2, 0, 6],
    Input_onClick: [function($event) {
      $.gamestate.onClick$0(0);
    }, "call$1", "ld38_Input_onClick$closure", 2, 0, 6],
    Input_onTouchStart: [function($event) {
      var t1 = J.getInterceptor$x($event);
      t1.preventDefault$0($event);
      t1 = t1.get$touches($event);
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      $.Input_mouseX = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.round$0(t1.clientX), C.JSNumber_methods.round$0(t1.clientY)), [null]).x;
      t1 = $event.touches;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      $.Input_mouseY = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.round$0(t1.clientX), C.JSNumber_methods.round$0(t1.clientY)), [null]).y;
      $.gamestate.onClick$0(0);
    }, "call$1", "ld38_Input_onTouchStart$closure", 2, 0, 16],
    LevelData_loadLevel: function(data) {
      var t1, width, level, tiles, t2, t3, i, t4, t5, t6, i0, j, t7, t8, t9, symbol, t10, connectLeft, connectTop, connectRight, connectBottom, rotation, k;
      t1 = data.length;
      if (0 >= t1)
        return H.ioore(data, 0);
      width = data[0].length;
      level = new G.Level(width, t1, null, null, null, null, null, null, null, null, null, null, null, null, null);
      level.onResize$0(0);
      level.organs = H.setRuntimeTypeInfo([], [G.Tile]);
      level.flowTiles = H.setRuntimeTypeInfo([], [G.Tile]);
      level.particleEmitters = H.setRuntimeTypeInfo([], [G.ParticleEmitter]);
      level.lost = false;
      level.won = false;
      level.next = false;
      level.sound = true;
      tiles = H.setRuntimeTypeInfo([], [[P.List, G.Tile]]);
      level.organs.push(null);
      for (t2 = t1 - 1, t3 = width - 1, i = 0; i < width; i = i0) {
        t4 = [];
        t4.$builtinTypeInfo = [G.Tile];
        tiles.push(t4);
        for (t4 = i < t3, t5 = i > 0, t6 = i - 1, i0 = i + 1, j = 0; j < t1; ++j) {
          t7 = data.length;
          if (j >= t7)
            return H.ioore(data, j);
          t8 = data[j];
          t9 = t8.length;
          if (i >= t9)
            return H.ioore(t8, i);
          ...
          if (symbol === " ") {
            ...
            t7 = tiles[i];
            t8 = new G.TileVessel(level, i, j, null, null, null, false, false, false, false, false, null, null, null, null, null);
            t8.infected = false;
            t8.oxygen = false;
            t8.blood = false;
            ...
            if (i >= tiles.length)
              return H.ioore(tiles, i);
            t7 = tiles[i];
            t8 = new G.TileVessel(level, i, j, null, null, null, false, $.random.nextBool$0(), $.random.nextBool$0(), $.random.nextBool$0(), $.random.nextBool$0(), null, null, null, null, null);
            t8.infected = false;
            t8.oxygen = false;
            t8.blood = false;
            t8.sourceBottom = false;
            ...
            if (t4) {
              if (i0 >= t9)
                return H.ioore(t8, i0);
              t8 = t8[i0];
              t8 = t8 !== " " && t8 !== ".";
            } else
              t8 = false;
            connectRight = t8 && true;
            if (j < t2) {
              t8 = j + 1;
              if (t8 >= t7)
              ...
              t7 = false;
            connectBottom = t7 && true;
            if (symbol === "+") {
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileVessel(level, i, j, null, null, null, false, true, true, true, true, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
              ...
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileVessel(level, i, j, null, null, null, false, true, true, true, false, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
              ...
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileVessel(level, i, j, null, null, null, false, true, false, true, false, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
              ...
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileVessel(level, i, j, null, null, null, false, true, true, false, false, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
              ...
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileVessel(level, i, j, null, null, null, false, true, false, false, false, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
              ...
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileHeart(0, level, i, j, null, null, null, true, connectLeft, connectTop, connectRight, connectBottom, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
              ...
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileHeart(1, level, i, j, null, null, null, true, connectLeft, connectTop, connectRight, connectBottom, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
              ...
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileHeart(2, level, i, j, null, null, null, true, connectLeft, connectTop, connectRight, connectBottom, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
              ...
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              t7 = tiles[i];
              t8 = new G.TileHeart(3, level, i, j, null, null, null, true, connectLeft, connectTop, connectRight, connectBottom, null, null, null, null, null);
              t8.infected = false;
              t8.oxygen = false;
              t8.blood = false;
              t8.sourceBottom = false;
            ...
            rotation = $.random.nextInt$1(4);
            for (k = 0; k < rotation; ++k) {
              if (i >= tiles.length)
                return H.ioore(tiles, i);
              J.rotate$0$x(J.$index$asx(tiles[i], j));
            }
          }
        }
      }
    ...
    main: [function() {
      ...
      $.buffer = e;
      $.canvasContext = J.get$context2D$x($.canvas);
      $.bufferContext = J.get$context2D$x($.buffer);
      t1 = J.get$onMouseMove$x($.canvas);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(G.ld38_Input_onMouseMove$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onClick$x($.canvas);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(G.ld38_Input_onClick$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = $.canvas;
      t1.toString;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "touchstart", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(G.ld38_Input_onTouchStart$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      $.Input_mouseY = 0;
      $.Input_mouseX = 0;
      G.Resources_load();
      ...
      G.onResize();
      C.Window_methods.get$animationFrame(window).then$1(G.ld38__frame$closure());
    }, "call$0", "ld38__main$closure", 0, 0, 1],
    onResize: function() {
      var t1, t2, t3;
      t1 = $.canvas;
      t2 = $.buffer;
      t3 = document.body;
      t3 = P.Rectangle$(C.JSNumber_methods.round$0(t3.clientLeft), C.JSNumber_methods.round$0(t3.clientTop), C.JSNumber_methods.round$0(t3.clientWidth), C.JSNumber_methods.round$0(t3.clientHeight), null).width;
      J.set$width$x(t2, t3);
      J.set$width$x(t1, t3);
      t3 = $.canvas;
      t1 = $.buffer;
      t2 = document.body;
      t2 = P.Rectangle$(C.JSNumber_methods.round$0(t2.clientLeft), C.JSNumber_methods.round$0(t2.clientTop), C.JSNumber_methods.round$0(t2.clientWidth), C.JSNumber_methods.round$0(t2.clientHeight), null).height;
      J.set$height$x(t1, t2);
      J.set$height$x(t3, t2);
      $.bufferContext.imageSmoothingEnabled = false;
      $.gamestate.onResize$0(0);
    },
    frame: [function(time) {
      var t1, updateTime;
      t1 = $.lastFrame;
      if (t1 == null) {
        if ($.Resources_doneLoading === true)
          $.lastFrame = time;
      } else {
        updateTime = J.$sub$n(time, t1);
        $.gamestate.update$1(updateTime);
        $.bufferContext.clearRect(0, 0, J.get$width$x($.canvas), J.get$height$x($.canvas));
        $.gamestate.draw$0();
        $.canvasContext.clearRect(0, 0, J.get$width$x($.canvas), J.get$height$x($.canvas));
        $.canvasContext.drawImage($.buffer, 0, 0);
        $.lastFrame = time;
      }
      C.Window_methods.get$animationFrame(window).then$1(G.ld38__frame$closure());
    }, "call$1", "ld38__frame$closure", 2, 0, 17],
    Resources_load: function() {
      var directions, types, _i, d, _i0, t;
      $.Resources_images = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, W.ImageElement);
      $.Resources_sounds = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, W.AudioElement);
      $.Resources_soundsLoaded = 0;
      $.Resources_imagesLoaded = 0;
      $.Resources_doneLoading = false;
      directions = ["left", "top", "right", "bottom", "center"];
      types = ["empty", "blood", "oxygen", "infected"];
      for (_i = 0; _i < 5; ++_i) {
        d = directions[_i];
        for (_i0 = 0; _i0 < 4; ++_i0) {
          t = types[_i0];
          G.Resources_loadImage("vessel_" + d + "_" + t);
        }
      }
      G.Resources_loadImage("vessel_center_break");
      G.Resources_loadImage("heart");
      G.Resources_loadImage("heart_arrow_left");
      G.Resources_loadImage("heart_arrow_top");
      G.Resources_loadImage("heart_arrow_right");
      ...
      G.Resources_loadImage("lost_mess");
      G.Resources_loadImage("lost_oxygen");
    ...
    Resources_loadImage: function(key) {
      ...
      J.set$src$x(e, t2);
      t2 = J.get$onLoad$x(e);
      t2.get$first(t2).then$1(new G.Resources_loadImage_closure());
      t1.$indexSet(0, key, e);
    },
    Resources_loadSound: function(key) {
      var t1, t2, t3;
      t1 = $.Resources_sounds;
      t2 = W.AudioElement_AudioElement("res/" + key + ".ogg");
      t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, "loadeddata", false), [null]);
      t3.get$first(t3).then$1(new G.Resources_loadSound_closure());
      t1.$indexSet(0, key, t2);
    },
    Resources_checkLoaded: function() {
      var t1, t2;
      t1 = $.Resources_imagesLoaded;
      t2 = $.Resources_images;
      t2 = t2.get$values(t2);
      t2 = t2.get$length(t2);
      if (t1 == null ? t2 == null : t1 === t2) {
        t1 = $.Resources_soundsLoaded;
        t2 = $.Resources_sounds;
        t2 = t2.get$values(t2);
        t2 = t2.get$length(t2);
        t2 = t1 == null ? t2 == null : t1 === t2;
        ...
        t1 = false;
      if (t1)
        $.Resources_doneLoading = true;
    },
    Gamestate: {
      "^": "Object;"
    },
    GamestateLevel: {
      "^": "Gamestate;levels,levelNumber,level",
      update$1: function(time) {
        var t1, t2;
        this.level.update$1(time);
        if (this.level.next === true) {
          t1 = this.levelNumber;
          if (typeof t1 !== "number")
            return t1.$add();
          ++t1;
          ...
          if (t1 >= 4)
            ...
            t2 = this.levels[t1];
            this.level = t2;
            t2.tutorialMessage = t1 < 3 ? t1 : null;
            t2.onResize$0(0);
          }
        }
      },
      draw$0: function() {
        var t1, t2, t3, scaleFactor, t4, t5, t6, t7, t8, t9, t10;
        this.level.draw$0();
        t1 = this.level;
        t2 = this.levelNumber;
        if (typeof t2 !== "number")
      ...
      onResize$0: function(_) {
        this.level.onResize$0(0);
      },
      onClick$0: function(_) {
        var t1, t2, scaleFactor, t3, t4, x, y, buttonX, t5, buttonY;
        t1 = this.level;
        if (t1.tutorialMessage != null)
          t1.tutorialMessage = null;
        else {
          t2 = $.Tile_width;
          if (typeof t2 !== "number")
            return t2.$div();
          ...
          if (t1.flowTime == null) {
            ...
            if (typeof t4 !== "number")
              return H.iae(t4);
            x = C.JSNumber_methods.$tdiv(t3 - t4, t2);
            t2 = $.Input_mouseY;
            t4 = t1.tileOffsetY;
            if (typeof t2 !== "number")
              return t2.$sub();
            ...
            if (typeof t3 !== "number")
              return H.iae(t3);
            y = C.JSNumber_methods.$tdiv(t2 - t4, t3);
            if (x >= 0 && x < t1.width && y >= 0 && y < t1.height) {
              t2 = t1.tiles;
              ...
              if (typeof t5 !== "number")
                return H.iae(t5);
              buttonY = t2 * t4 + t5 + 8 * scaleFactor;
              t2 = $.Input_mouseX;
              if (typeof t2 !== "number")
                return t2.$gt();
              if (t2 > buttonX)
                if (t2 < buttonX + t3) {
                  ...
                  if (typeof t2 !== "number")
                    return t2.$gt();
                  t2 = t2 > buttonY && t2 < buttonY + 16 * scaleFactor;
                } else
                  t2 = false;
              else
                t2 = false;
            ...
            if (typeof t5 !== "number")
              return H.iae(t5);
            buttonY = t2 * t4 + t5 + 15 * scaleFactor;
            t2 = $.Input_mouseX;
            if (typeof t2 !== "number")
              return t2.$gt();
            if (t2 > buttonX)
    ...
    Level: {
      ...
      resetTiles$0: function() {
        ...
        for (i = 0; i < this.width; ++i)
          for (j = 0; j < this.height; ++j) {
            ...
            if (i >= t1.length)
              return H.ioore(t1, i);
            J.reset$0$x(J.$index$asx(t1[i], j));
          }
        this.flowTime = null;
        t1 = this.particleEmitters;
      ...
      addLeak$3: function(leakingTile, offsetX, offsetY) {
        ...
        if (leakingTile.infected === true)
          color = "#00B227";
        else if (leakingTile.oxygen === true)
          color = "#E12B27";
        else
          color = leakingTile.blood === true ? "#005DFF" : null;
        t1 = this.particleEmitters;
        t2 = leakingTile.x;
        t3 = $.Tile_width;
        if (typeof t3 !== "number")
      ...
      checkOxygen$0: function() {
        var i, t1;
        for (i = 0; t1 = this.organs, i < t1.length; ++i)
      ...
      update$1: function(time) {
        ...
        if (t1 != null) {
          ...
          this.flowTime = t1;
          if (t1 >= 200) {
            _flowTiles = H.setRuntimeTypeInfo([], [G.Tile]);
            for (i = 0; t1 = this.flowTiles, i < t1.length; ++i)
              t1[i].update$1(_flowTiles);
        ...
        for (i = 0; t1 = this.particleEmitters, i < t1.length; ++i)
          t1[i].update$1(time);
      },
      draw$0: function() {
        var i, j, t1, scaleFactor, t2, buttonX, t3, t4, buttonY, buttonHeight, t5, t6, t7;
        for (i = 0; i < this.width; ++i)
          for (j = 0; j < this.height; ++j) {
            t1 = this.tiles;
            if (i >= t1.length)
              return H.ioore(t1, i);
            J.$index$asx(t1[i], j).draw$0();
          }
        for (i = 0; t1 = this.particleEmitters, i < t1.length; ++i)
          t1[i].draw$2(this.tileOffsetX, this.tileOffsetY);
        t1 = $.Tile_width;
        if (typeof t1 !== "number")
          return t1.$div();
        scaleFactor = t1 / 16;
        if (this.flowTime == null) {
          ...
          if (typeof t4 !== "number")
            return H.iae(t4);
          buttonY = t1 * t3 + t4 + 8 * scaleFactor;
          buttonHeight = 16 * scaleFactor;
          t1 = $.Input_mouseX;
          if (typeof t1 !== "number")
            return t1.$gt();
          if (t1 > buttonX)
            if (t1 < buttonX + t2) {
              ...
              if (typeof t1 !== "number")
                return t1.$gt();
              t1 = t1 > buttonY && t1 < buttonY + buttonHeight && this.tutorialMessage == null;
            } else
              t1 = false;
          else
            t1 = false;
          ...
          if (typeof t7 !== "number")
            return H.iae(t7);
          t1.drawImage(t2, (t3 - t4) / 2, t5 * t6 + t7 + scaleFactor, t4, 13 * scaleFactor);
          t4 = J.get$width$x($.canvas);
          t7 = 32 * scaleFactor;
          if (typeof t4 !== "number")
            return t4.$sub();
          buttonX = (t4 - t7) / 2;
          ...
          if (typeof t5 !== "number")
            return H.iae(t5);
          buttonY = t4 * t6 + t5 + 15 * scaleFactor;
          buttonHeight = 16 * scaleFactor;
          t1 = $.Input_mouseX;
          if (typeof t1 !== "number")
            return t1.$gt();
          if (t1 > buttonX)
            if (t1 < buttonX + t7) {
              ...
              if (typeof t1 !== "number")
                return t1.$gt();
              t1 = t1 > buttonY && t1 < buttonY + buttonHeight;
            } else
              t1 = false;
          else
            t1 = false;
        ...
        if (this.tutorialMessage != null) {
          t1 = $.bufferContext;
          t2 = $.Resources_images.$index(0, "tutorial");
          t3 = this.tutorialMessage;
          if (typeof t3 !== "number")
            return t3.$mul();
          t4 = J.get$width$x($.canvas);
          t5 = 114 * scaleFactor;
      ...
      onResize$0: function(_) {
        var gameWidth, gameHeight, t1, t2, t3;
        gameWidth = P.max(this.width, 7);
        gameHeight = this.height + 3;
        t1 = J.get$width$x($.canvas);
        ...
        if (typeof t2 !== "number")
          return H.iae(t2);
        t3 = $.canvas;
        if (t1 / t2 > gameWidth / gameHeight) {
          t1 = J.get$height$x(t3);
          if (typeof t1 !== "number")
            return t1.$div();
          t1 /= gameHeight;
          $.Tile_height = t1;
        ...
        if (typeof t1 !== "number")
          return t1.$sub();
        this.tileOffsetX = (t1 - t2 * t3) / 2;
        this.tileOffsetY = $.Tile_height;
      }
    },
    main_closure: {
      "^": "Closure:2;",
    ...
    ParticleEmitter: {
      "^": "Object;x>,y>,biasX,biasY,color,particles",
      update$1: function(time) {
        var t1, t2, t3, j, t4, t5, angle, speed, t6, t7, i;
        for (t1 = this.biasX, t2 = this.biasY, t3 = this.color, j = 0; j < 3; ++j) {
          t4 = this.particles;
          t5 = new G.Particle(this.x, this.y, t1, t2, null, null, t3, null);
          angle = $.random.nextDouble$0() * 2 * 3.141592653589793;
          speed = $.random.nextDouble$0();
          t6 = Math.cos(angle);
          t7 = $.Tile_width;
          if (typeof t7 !== "number")
            return H.iae(t7);
          t5.velocityX = (t6 + t1) * speed * t7 / 256;
          t6 = Math.sin(angle);
          t7 = $.Tile_height;
          if (typeof t7 !== "number")
            return H.iae(t7);
          t5.velocityY = (t6 + t2) * speed * t7 / 256;
          t5.lifeTime = 500;
          t4.push(t5);
        }
        for (i = 0; t1 = this.particles, t2 = t1.length, i < t2; ++i) {
          if (i < 0)
            return H.ioore(t1, i);
          t3 = t1[i];
          t4 = t3.x;
          ...
          t6 = t3.velocityY;
          t3.y = t4 + t6 * time;
          t3.velocityX = t5 * 0.95;
          t3.velocityY = t6 * 0.95;
          t3 = t3.lifeTime -= time;
          if (t3 <= 0) {
            if (i >= t2)
              H.throwExpression(P.RangeError$value(i, null, null));
            t1.splice(i, 1)[0];
            --i;
          }
        }
      },
      draw$2: function(tileOffsetX, tileOffsetY) {
        var i, t1, t2, t3, t4, t5;
        for (i = 0; t1 = this.particles, i < t1.length; ++i) {
          t1 = t1[i];
          t2 = $.bufferContext;
          t2.fillStyle = t1.color;
          t3 = t1.x;
          if (typeof tileOffsetX !== "number")
            return H.iae(tileOffsetX);
          t1 = t1.y;
          if (typeof tileOffsetY !== "number")
            return H.iae(tileOffsetY);
          t4 = $.Tile_width;
          if (typeof t4 !== "number")
            return t4.$div();
          t5 = $.Tile_height;
          if (typeof t5 !== "number")
            return t5.$div();
          t2.fillRect(t3 + tileOffsetX, t1 + tileOffsetY, t4 / 8, t5 / 8);
        }
      }
    },
    Particle: {
      "^": "Object;x>,y>,biasX,biasY,velocityX,velocityY,color,lifeTime",
      update$1: function(time) {
        var t1, t2, t3;
        t1 = this.x;
        t2 = this.velocityX;
        ...
        t3 = this.velocityY;
        this.y = t1 + t3 * time;
        this.velocityX = t2 * 0.95;
        this.velocityY = t3 * 0.95;
        this.lifeTime -= time;
      }
    },
    Resources_loadImage_closure: {
      "^": "Closure:2;",
      call$1: function(e) {
        var t1 = $.Resources_imagesLoaded;
        if (typeof t1 !== "number")
          return t1.$add();
        $.Resources_imagesLoaded = t1 + 1;
        G.Resources_checkLoaded();
        return;
      }
    },
    Resources_loadSound_closure: {
      "^": "Closure:2;",
      call$1: function(e) {
        var t1 = $.Resources_soundsLoaded;
        if (typeof t1 !== "number")
          return t1.$add();
        $.Resources_soundsLoaded = t1 + 1;
        G.Resources_checkLoaded();
        return;
      }
    },
    Tile: {
      "^": "Object;x>,y>,blood<,oxygen<,infected<,connectionLeft<,connectionTop<,connectionRight<,connectionBottom<",
      reset$0: function(_) {
        this.infected = false;
        this.oxygen = false;
        this.blood = false;
        this.sourceBottom = false;
        this.sourceRight = false;
        this.sourceTop = false;
        this.sourceLeft = false;
        this.breakAnimationFrame = null;
      },
      rotate$0: ["super$Tile$rotate", function(_) {
        var _connectionLeft = this.connectionLeft;
        this.connectionLeft = this.connectionBottom;
        this.connectionBottom = this.connectionRight;
        this.connectionRight = this.connectionTop;
        this.connectionTop = _connectionLeft;
      }],
      update$1: ["super$Tile$update", function(flowTiles) {
        var t1, t2, source, drain, leakLeft, flowTile, leakTop, t3, leakRight, leakBottom, color, t4, t5, t6;
        t1 = this.breakAnimationFrame;
        if (t1 == null) {
          if (this.sourceLeft === true) {
            t1 = this.level.tiles;
            t2 = this.x - 1;
            if (t2 < 0 || t2 >= t1.length)
              return H.ioore(t1, t2);
            source = J.$index$asx(t1[t2], this.y);
            this.blood = this.blood === true || source.get$blood() === true;
            if (this.oxygen !== true)
              t1 = source.get$oxygen() === true && !source.usesOxygen;
            else
              t1 = true;
            this.oxygen = t1;
            this.infected = this.infected === true || source.get$infected() === true;
            drain = false;
            leakLeft = false;
          } else if (this.connectionLeft) {
            t1 = this.x;
            if (t1 > 0) {
              t2 = this.level.tiles;
              --t1;
              if (t1 >= t2.length)
                return H.ioore(t2, t1);
              flowTile = J.$index$asx(t2[t1], this.y);
              if (flowTile.get$connectionRight()) {
                flowTile.sourceRight = true;
                if (!(flowTiles && C.JSArray_methods).contains$1(flowTiles, flowTile))
                  flowTiles.push(flowTile);
                leakLeft = false;
              } else
                leakLeft = true;
            } else
          ...
          if (this.sourceTop === true) {
            t1 = this.level.tiles;
            t2 = this.x;
            if (t2 >= t1.length)
              return H.ioore(t1, t2);
            source = J.$index$asx(t1[t2], this.y - 1);
            this.blood = this.blood === true || source.get$blood() === true;
            if (this.oxygen !== true)
              t1 = source.get$oxygen() === true && !source.usesOxygen;
            else
            ...
            if (t1 > 0) {
              ...
              flowTile = J.$index$asx(t2[t3], t1 - 1);
              if (flowTile.get$connectionBottom()) {
          ...
          if (this.sourceRight === true) {
            ...
            if (t1 < t2.width - 1) {
              ...
              if (t1 >= t2.length)
                return H.ioore(t2, t1);
              flowTile = J.$index$asx(t2[t1], this.y);
              if (flowTile.get$connectionLeft()) {
          ...
          if (this.sourceBottom === true) {
            ...
            leakBottom = false;
          if (!drain) {
            this.breakAnimationFrame = -1;
            flowTiles.push(this);
          }
          if (leakLeft)
            this.level.addLeak$3(this, -1, 0);
          if (leakTop)
            this.level.addLeak$3(this, 0, -1);
          if (leakRight)
            this.level.addLeak$3(this, 1, 0);
          if (leakBottom)
            this.level.addLeak$3(this, 0, 1);
          ...
          if (typeof t1 !== "number")
            return t1.$add();
          ++t1;
          this.breakAnimationFrame = t1;
          if (t1 > 2) {
            this.breakAnimationFrame = 2;
            t1 = this.level;
            if (this.infected === true)
              color = "#00B227";
            else if (this.oxygen === true)
              color = "#E12B27";
            else
              color = this.blood === true ? "#005DFF" : null;
            t2 = t1.particleEmitters;
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
      ...
      draw$0: ["super$Tile$draw", function() {
        var type, t1, t2, t3, t4, t5, t6, t7, t8, t9, frameY;
        if (this.infected === true)
          type = "infected";
        else if (this.oxygen === true)
          type = "oxygen";
        else
          type = this.blood === true ? "blood" : "empty";
        if (this.connectionLeft || this.connectionTop || this.connectionRight || this.connectionBottom) {
          t1 = this.breakAnimationFrame;
          if (t1 != null) {
            if (typeof t1 !== "number")
              return t1.$lt();
          ...
          if (this.connectionLeft) {
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "vessel_left_" + type);
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
          ...
          if (this.connectionTop) {
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "vessel_top_" + type);
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
          ...
          if (this.connectionBottom) {
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "vessel_bottom_" + type);
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
          ...
          if (this.connectionRight) {
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "vessel_right_" + type);
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
          ...
          if (t1) {
            if (type === "blood")
              ...
              frameY = type === "infected" ? 3 : null;
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "vessel_center_break");
            t3 = this.breakAnimationFrame;
            if (typeof t3 !== "number")
              return t3.$mul();
            if (typeof frameY !== "number")
              return frameY.$mul();
            t4 = this.x;
            t5 = $.Tile_width;
            if (typeof t5 !== "number")
            ...
            if (typeof t6 !== "number")
              return H.iae(t6);
            t1.drawImage(t2, t3 * 16, frameY * 16, 16, 16, t4 * t5 + t7, t8 * t9 + t6, t5, t9);
          }
        }
      }]
    },
    ...
    TileHeart: {
      "^": "Tile;flowDirection,level,x,y,blood,oxygen,infected,usesOxygen,connectionLeft,connectionTop,connectionRight,connectionBottom,sourceLeft,sourceTop,sourceRight,sourceBottom,breakAnimationFrame",
      rotate$0: function(_) {
        this.super$Tile$rotate(this);
        if (++this.flowDirection > 3)
          this.flowDirection = 0;
      },
      update$1: function(flowTiles) {
        var t1, t2, flowTile, t3, source;
        if (this.blood !== true) {
          this.blood = true;
          t1 = this.flowDirection;
          if (t1 === 0) {
            t1 = this.x;
            t2 = this.level;
            if (t1 > 0) {
          ...
          this.oxygen = t1;
          this.infected = this.infected === true || source.get$infected() === true;
        } else if (this.sourceBottom === true) {
          t1 = this.level.tiles;
          t2 = this.x;
          if (t2 >= t1.length)
            return H.ioore(t1, t2);
      ...
      draw$0: function() {
        ...
        t1 = $.bufferContext;
        t2 = $.Resources_images.$index(0, "heart");
        t3 = this.x;
        t4 = $.Tile_width;
        if (typeof t4 !== "number")
          return H.iae(t4);
        ...
        switch (this.flowDirection) {
          case 0:
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "heart_arrow_left");
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
          ...
          case 1:
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "heart_arrow_top");
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
          ...
          case 2:
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "heart_arrow_right");
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
          ...
          case 3:
            t1 = $.bufferContext;
            t2 = $.Resources_images.$index(0, "heart_arrow_bottom");
            t3 = this.x;
            t4 = $.Tile_width;
            if (typeof t4 !== "number")
              return H.iae(t4);
    ...
    TileLungs: {
      ...
      update$1: function(flowTiles) {
        this.oxygen = true;
        this.super$Tile$update(flowTiles);
      },
      draw$0: function() {
        var t1, t2, t3, t4, t5, t6, t7, t8;
        this.super$Tile$draw();
        t1 = $.bufferContext;
        t2 = $.Resources_images.$index(0, "lungs");
        t3 = this.x;
        t4 = $.Tile_width;
        if (typeof t4 !== "number")
          return H.iae(t4);
    ...
    TileLiver: {
      ...
      draw$0: function() {
        ...
        this.super$Tile$draw();
        t1 = $.bufferContext;
        t2 = $.Resources_images.$index(0, "liver");
        t3 = this.x;
        t4 = $.Tile_width;
        if (typeof t4 !== "number")
          return H.iae(t4);
  ...
  J.rotate$0$x = function(receiver) {
    return J.getInterceptor$x(receiver).rotate$0(receiver);
  };
  ...
  $.gamestate = null;
  $.lastFrame = null;
  $.Resources_images = null;
  $.Resources_sounds = null;
  $.Resources_imagesLoaded = null;
  $.Resources_soundsLoaded = null;
  $.Resources_doneLoading = null;
  $.Tile_width = null;
  $.Tile_height = null;
  $ = null;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, void: true, args: [W.MouseEvent]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol,,]}, {func: 1, void: true, args: [W.TouchEvent]}, {func: 1, void: true, args: [P.num]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(G.ld38__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(G.ld38__main$closure(), a);
